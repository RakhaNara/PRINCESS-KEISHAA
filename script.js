const CONFIG = {
    ...
    subQuestion: "Please say yes ❤️",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: [
        "Haha, you can't escape 😝",
        "Hehe, try again 😜",
        "Okay fine... I'll take that as a YES! 💕"
    ],
    confirmTitle: "YAAAY! You Said Yes 💗",
    confirmText: "From this moment on, you are officially...",
    badgeText: "My Valentine 💖",
    nextButton: "Continue ",
    repeatButton: "Ask Again ",
    flowerTitle: "A Special Gift Just for You 🌸",
    takeBouquetButton: "Accept the Gift ",
    bouquetMessage: "Yay! It's officially yours now 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Beautiful You",
    collageSubtitle: "Since you came into my life, even the simplest moments feel special. Happy Valentine’s Day, my favorite person. 💕",
    nextCollageButton: "One More Page… ",
    finalTitle: "Happy Valentine’s Day, My Love 💞",
    finalMessage: `Thank you for being part of my life and making every day feel complete. You are the reason my smile comes so easily. I hope your days are always filled with warmth, happiness, and love. I will always be here for you. Happy Valentine’s Day 💕`,
    restartButton: "Restart ",
    copyButton: "Copy Message ",
    copySuccess: "Message copied successfully! "
};
